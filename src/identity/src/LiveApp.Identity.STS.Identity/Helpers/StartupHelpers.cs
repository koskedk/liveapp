...
using LiveApp.Identity.STS.Identity.Configuration.ApplicationParts;
using LiveApp.Identity.STS.Identity.Configuration.Constants;
using LiveApp.Identity.STS.Identity.Configuration.Interfaces;
using LiveApp.Identity.STS.Identity.Helpers.Localization;
using LiveApp.Identity.STS.Identity.Services;

namespace LiveApp.Identity.STS.Identity.Helpers
{
