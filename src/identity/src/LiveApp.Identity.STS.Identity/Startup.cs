...
using LiveApp.Identity.STS.Identity.Helpers;
using LiveApp.Identity.STS.Identity.Configuration;
using LiveApp.Identity.STS.Identity.Configuration.Constants;
using LiveApp.Identity.STS.Identity.Configuration.Interfaces;

namespace LiveApp.Identity.STS.Identity
{
